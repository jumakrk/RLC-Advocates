...
<head>
    ...
    <link rel="icon" sizes="192x192" href="<?= asset_url('assets/img/rlc_blue_circular_favicon.png') ?>">
    ...
    <?php slot('styles'); ?>
    <link rel="stylesheet" type="text/css" href="<?= asset_url('assets/css/custom.css') . '?v=' . time() ?>">
</head>
<body>
