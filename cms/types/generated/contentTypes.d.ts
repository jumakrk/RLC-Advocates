...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog posts and legal insights';
    displayName: 'Article';
    pluralName: 'articles';
  ...
  attributes: {
    category: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Legal Insight'>;
...
export interface ApiTeamMemberTeamMember extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Profiles for RLC Advocates Team Members';
  ...
  attributes: {
    ...
    bar_admissions: Schema.Attribute.RichText;
    bio: Schema.Attribute.RichText;
    bio_short: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    focus_areas: Schema.Attribute.Text;
